(() => {
    ...
    let swiperWrap = document.querySelector(".gallery__wrapper");
    const modalArr = [ {
    ...
    const sliders_element = document.createElement("section");
    class PopupFrame {
    ...
    swiperWrap.addEventListener("click", (e => {
        if (!document.querySelector(".button__watch").classList.contains("active-btn")) {
            e.preventDefault();
            ...
            document.querySelector(".open-modal").classList.add("active-btn");
        }
    }));
    function stopPopup() {
        sliders_element.remove();
        document.querySelector(".open-modal").classList.remove("active-btn");
    }
